...
const Profile = () => {
  ...
  const fetchCities = async (country) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://vivacious-fanchon-ceylonweb-e40cba11.koyeb.app/api/locations/cities/${encodedCountry}`,
      );
  ...
  const fetchUnreadCount = async () => {
    try {
      ...
      const response = await axios.get(
        "https://vivacious-fanchon-ceylonweb-e40cba11.koyeb.app/api/notifications/unread-count",
        {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const response = await axios.get(
        "https://vivacious-fanchon-ceylonweb-e40cba11.koyeb.app/api/auth/profile",
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
      ...
      async (position) => {
        ...
        try {
          ...
          if (data && data.address) {
            ...
            detectedCountry =
              countryMapping[detectedCountry] || detectedCountry;
            ...
            try {
              ...
              if (citiesResponse.data && citiesResponse.data.length > 0) {
                ...
                setSuccess(
                  `✓ Location set to ${finalCity}, ${detectedCountry}. Country & City dropdowns updated!`,
                );
              } else {
              ...
              setError(
                `Country "${detectedCountry}" not in our database. Please select manually.`,
              );
            }
          } else {
            setError(
              "Could not detect location details. Please select manually.",
            );
          }
          ...
          setError(
            "Error detecting location. Please try again or select manually.",
          );
        ...
        return (
          <div className="profile-section">
            ...
            <p className="setup-description">
              Choose what you'd like to add to Ceylon Compass
            </p>
            <div className="setup-cards">
              ...
              >
                <img
                  src="/src/assets/images/restaurant-card.jpg"
                  alt="Restaurant"
              ...
              >
                <img
                  src="/src/assets/images/apartment-card.jpg"
                  alt="Accommodation"
                  className="setup-image"
                />
                <div className="setup-content">
              ...
              >
                <img
                  src="/src/assets/images/event-card.jpg"
                  alt="Event"
                  className="setup-image"
                />
                <div className="setup-content">
          ...
          <div className="profile-section">
            ...
            <form onSubmit={handleProfileUpdate}>
              ...
              <div className="form-group">
                ...
                >
                  You can update your location anytime using GPS. Country, City,
                  and Address will be auto-filled.
                </small>
              </div>
